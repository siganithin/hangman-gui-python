"""
Hangman Game with Advanced GUI using Python & Tkinter
Author: Siga Nithin
Description:
  - Category-based word guessing game
  - Interactive GUI with difficulty selection and dynamic background
  - Includes clues, timer, and visual hangman drawing
"""

import requests   # Downloads background image from a URL.
from PIL import Image, ImageTk  # Handles image loading and resizing
import tkinter as tk  # GUI framework.
from tkinter import messagebox
import random    # Picks a random word.
import os 	# Checks if the background image file exists.
